...
class MLPPolicySAC(MLPPolicy):
    ...
    def forward(self, observation: torch.FloatTensor):
        ...
        if self.discrete:
            ...
            clipped_log_std = torch.exp(self.logstd.clamp(min=log_std_min, max=log_std_max))
            action_distribution = sac_utils.SquashedNormal(batch_mu, clipped_log_std)
    ...
    def update(self, obs, critic):
        ...
        act_s = act_obs.rsample()

        act_s_logl = act_obs.log_prob(act_s)
